...
tags:
  - Kubernetes
abbrlink: facb79db
date: 2023-12-21 15:44:53
---

# 搭建Kubernetes集群（三）

上篇文章我们搭建好了Kubernetes的主节点，本篇文章介绍node节点的加入和可视化界面的搭建。
...
在node1和node2节点中使用上述命令，将node1和node2节点加入master节点，此命令24小时有效。
...
**如果大家不能科学上网，可能上述命令执行不能成功，可以新建一个yaml，之后在执行它。**
...
***访问： https://集群任意IP:端口      https://192.168.43.130:30836***
